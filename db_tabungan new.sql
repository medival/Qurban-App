...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Nov 2021 pada 06.53
...
(10, 1212, 5, 56, 'Pendaftaran Baru', '2021-11-27 05:11:52'),
(11, 1212, 8, 63, 'Naik Kelas', '2021-11-27 05:15:13'),
(12, 1234, 8, 56, 'Pendaftaran Baru', '2021-11-27 05:17:05');
...
(67, 1212, '1637989941', 'kredit', 200000, 1513000, NULL);
...
--
ALTER TABLE `tb_kelas_siswa`
  MODIFY `id_ksiswa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tb_kelas_siswa`
  ADD CONSTRAINT `tb_kelas_siswa_ibfk_1` FOREIGN KEY (`id_ruang`) REFERENCES `tb_ruang` (`id_ruang`),
  ADD CONSTRAINT `tb_kelas_siswa_ibfk_2` FOREIGN KEY (`id_tahun`) REFERENCES `tb_tahun` (`id_tahun`),
