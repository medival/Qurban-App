<script>
    $(document).ready(function() {
        ...
        function getrole() {
            $.ajax({
                type: "ajax",
                url: '<?= base_url('admin/getroleadmin'); ?>',
                async: false,
                dataType: 'JSON',
                success: function(data) {
                    console.log(data);
                ...
                success: function(data) {
                    ...
                    for (i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td>' + created_at + '</td>' +
                            '<td>' +
                            '<a href="javascript:void(0);"  class="btn btn-icon icon-left btn-outline-primary editUser" data-id="' + id + '" data-name="' + name + '" data-email="' + email + '" data-role="' + role + '"> <i class="fa fa-file-alt"></i> </a> ' +
